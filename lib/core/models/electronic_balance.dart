...
class ElectronicBalanceSaleOption implements SyncableEntity {
  ...
  ElectronicBalanceSaleOption({String? id, required this.category, required this.amount, SyncMetadata? metadata}) : id = id ?? IdGenerator.newId(), metadata = metadata ?? SyncMetadata.initial();
  Map<String, dynamic> toMap() => {'id': id, 'category': category, 'amount': amount, 'metadata': metadata.toMap()};
  factory ElectronicBalanceSaleOption.fromMap(Map<String, dynamic> map) => ElectronicBalanceSaleOption(id: map['id']?.toString(), category: map['category']?.toString() ?? '', amount: _double(map['amount']), metadata: _metadata(map['metadata']));
...
class ElectronicBalanceAccount implements SyncableEntity {
  ...
  @override final SyncMetadata metadata;
  ElectronicBalanceAccount({required this.id, required this.companyName, required this.commissionRate, required this.balance, List<ElectronicBalanceSaleOption> saleOptions = const [], SyncMetadata? metadata}) : saleOptions = List.unmodifiable(saleOptions), metadata = metadata ?? SyncMetadata.initial();
  ...
  ElectronicBalanceAccount copyWith({String? id, String? companyName, double? commissionRate, double? balance, List<ElectronicBalanceSaleOption>? saleOptions, SyncMetadata? metadata, bool touchMetadata = true}) => ElectronicBalanceAccount(id: id ?? this.id, companyName: companyName ?? this.companyName, commissionRate: commissionRate ?? this.commissionRate, balance: balance ?? this.balance, saleOptions: saleOptions ?? this.saleOptions, metadata: metadata ?? (touchMetadata ? this.metadata.touch() : this.metadata));
  ...
  factory ElectronicBalanceAccount.fromMap(Map<String, dynamic> map) => ElectronicBalanceAccount(id: map['id']?.toString() ?? '', companyName: map['companyName']?.toString() ?? '', commissionRate: _double(map['commissionRate']), balance: _double(map['balance']), saleOptions: _options(map['saleOptions']), metadata: _metadata(map['metadata']));
...
class ElectronicBalanceTransaction implements SyncableEntity {
  ...
  final String? saleId;
  @override final SyncMetadata metadata;
  ElectronicBalanceTransaction({required this.id, required this.accountId, required this.type, required this.amount, required this.providerCost, required this.profit, required this.category, required this.description, required this.createdAt, this.saleId, SyncMetadata? metadata}) : metadata = metadata ?? SyncMetadata(createdAt: createdAt.toUtc(), updatedAt: createdAt.toUtc());
