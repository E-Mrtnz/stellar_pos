...
class SaleDetailDialog extends StatelessWidget {
  ...
  double get _initialPayment =>
      sale.received.clamp(0, sale.total).toDouble();
  ...
  Future<void> _delete(BuildContext context) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: Text(
          '¿Seguro que deseas eliminar la venta #${sale.ticketNumber}? El inventario y el saldo electrónico asociado serán revertidos.',
        ),
        actions: [
          TextButton(
    ...
    if (deleted) {
      ...
      AppAlert.show(
        context,
        'La venta #${sale.ticketNumber} fue eliminada.',
