        ...
        children: [
          ...
          if (operationDifference != null) ...[
            ...
            Row(
              ...
              children: [
                Text(
                  operationDifferenceLabel ?? 'Diferencia',
                  style: AppTextStyles.ticketLabel,
                ),
                Text(
                  operationDifference!.abs() < 0.005
                      ? '\$0.00'
                      : '\$${operationDifference!.abs().toStringAsFixed(2)}',
                  style: const TextStyle(
                    fontSize: 12,
      ...
      Row(
        ...
        children: [
          ...
          Text(
            value,
            style: muted
                ? AppTextStyles.ticketValue.copyWith(
                    color: AppColors.textSecondary,
                  )
