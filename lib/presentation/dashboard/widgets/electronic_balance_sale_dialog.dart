                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                        ...
                        children: accounts
                            .map(
                              (item) => _CompanyChoice(
                                ...
                                onTap: () => setState(() {
                                  _accountId = item.id;
                                  if (!item.saleCategories.contains(_category)) {
                                    _category = item.saleCategories.first;
                                  }
                                }),
                              ),
                            )
                      ...
                      if (account != null) ...[
                        ...
                        Wrap(
                          spacing: 8,
                          runSpacing: 8,
                          children: categories.map((value) => _ChoiceChip(
                            label: value,
...
class _CompanyChoice extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final hasImage = account.imageData.trim().isNotEmpty;
    return InkWell(
      onTap: onTap,
