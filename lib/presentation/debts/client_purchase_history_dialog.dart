...
class ClientPurchaseHistoryDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final paidBySale = _paidBySale(debtProvider);
            ...
            Flexible(
              child: ordered.isEmpty
                  ? const Padding(
                      ...
                      child: Text(
                        'Este cliente todavía no tiene compras a fiado.',
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (_, index) {
                        final sale = ordered[index];
                        return _SaleHistoryCard(
                          sale: sale,
                          paidAmount: paidBySale[sale.id] ?? 0,
                        );
                      },
                    ),
            ),
...
class _SaleHistoryCard extends StatelessWidget {
  ...
  Future<void> _delete(BuildContext context) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (dialogContext) => _ConfirmDialog(
        ...
        details: const [
          'La venta desaparecerá del historial y de las cuentas por cobrar.',
          'Los productos físicos volverán al inventario.',
        ],
  ...
  Widget build(BuildContext context) {
    ...
    final remaining = (sale.total - paidAmount).clamp(0, double.infinity).toDouble();
    final isPaid = remaining <= 0.005;
    final isPartial = paidAmount > 0.005 && !isPaid;
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              ...
              IconButton(
                ...
                onPressed: isPaid ? null : () => _edit(context),
          ...
          Row(
            ...
            children: [
              Text(
                'Abonado: \$${paidAmount.toStringAsFixed(2)}',
                ...
                Row(
                  children: [
                    Container(
                      ...
                      height: 38,
                      decoration: BoxDecoration(
                        color: (danger ? AppColors.dangerRed : AppColors.primary).withAlpha(16),
                        borderRadius: BorderRadius.circular(10),
                      ),
                      child: Icon(
                        icon,
                ...
                Row(
                  ...
                  children: [
                    ...
                    FilledButton(
                      onPressed: onConfirm,
                      style: danger
                          ? FilledButton.styleFrom(backgroundColor: AppColors.dangerRed)
                          : null,
